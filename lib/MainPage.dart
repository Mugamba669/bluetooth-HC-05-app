// ignore_for_file: use_build_context_synchronously, sort_child_properties_last, library_private_types_in_public_api
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: const Text("Discoverable requested"),
                ...
                if (value) {
                  FlutterBluetoothSerial.instance.setPairingRequestHandler(
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text("Trying to auto-pair with Pin 1234"),
                    ));
              ...
              title: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (selectedDevice != null) {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content:
                          Text('Connect -> selected ${selectedDevice.address}'),
                    ));
                    _startChat(context, selectedDevice);
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Connect -> no device selected'),
                      ),
                    );
                  }
                },
